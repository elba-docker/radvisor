// ? This package has been forked from upstream at https://github.com/mmstick/numtoa to
// ? support efficient heap-free conversions involving u128's
                ...
                if cfg!(debug_assertions) {
                    if base == 10 {
                        match size_of::<$t>() {
                            ...
                            16 => debug_assert!(string.len() >= 40, "i128 base 10 conversions require at least 40 bytes"),
                            _ => unreachable!()
                        }
                    }
                }
